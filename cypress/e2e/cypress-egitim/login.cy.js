describe('Login Test', () => {
    ...
    it('Kayit Ol ve Giris Yap', () => {
        ...
        const updatedTodoText2 = 'Güncellenmiş Görev 2';

        const newTodoText3 = 'Yeni Görev 3';
        const updatedTodoText3 = 'Güncellenmiş Görev 3';

        const newTodoText4 = 'Yeni Görev 4';
        const updatedTodoText4 = 'Güncellenmiş Görev 4';
        ...
        cy.contains(newTodoText1).parent().find('.status-select').should('have.value', 'Tamamlandı');
           ...
           //to-do güncelleme
           cy.get('#todo-list').contains(newTodoText1)
          .parent()
          .find('.update-btn')
          .click();
        ...
        cy.get('#todo-list')
          ...
          .click()
          .should('have.value', newTodoText1)
          .clear()
          .type(updatedTodoText1)
          .blur();  
        ...
        //to-do silme
        cy.get('#todo-list').contains(newTodoText4)
          .parent()
          .find('.delete-btn')
          .click();
