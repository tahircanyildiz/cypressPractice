describe('Cypress Write File', () => {
    it('write file', () => {
        ...
        cy.writeFile('CypressWriteFileDoc/exampleFile.txt', 'Bu egitim serisinde sifirdan ileri seviyeye cypress tahir ogreneceksiniz.', {flag:'a+'})
    });
});
